package com.mycompany.oopmotorph.payrollstaff.ui;

import com.mycompany.oopmotorph.app.AppContext;
import com.mycompany.oopmotorph.payrollstaff.ui.pages.PayrollAttendancePage;
import com.mycompany.oopmotorph.payrollstaff.ui.pages.PayrollProcessingPage;
...
public class PayrollStaffFrame extends JFrame {
    private final CardLayout cardLayout = new CardLayout(); private final JPanel contentPanel = new JPanel(cardLayout); private final JLabel lblTitle = new JLabel("Payroll Staff Dashboard"); private final JButton btnUser = new JButton();
    ...
    private static final String PAGE_ATTENDANCE = "attendance", PAGE_PROCESSING = "processing";
    public PayrollStaffFrame(String employeeNo, String lastName, String firstName) { this(employeeNo, lastName, firstName, AppContext.createDefault()); }
    public PayrollStaffFrame(String employeeNo, String lastName, String firstName, AppContext appContext) {
        super("MotorPH - Payroll Staff"); this.employeeNo=employeeNo; this.lastName=lastName; this.firstName=firstName; this.appContext=appContext; this.timeLogService=appContext.getTimeLogService();
    ...
    private void registerPages() { contentPanel.add(new PayrollAttendancePage(appContext.getPayrollAttendanceService()), PAGE_ATTENDANCE); contentPanel.add(new PayrollProcessingPage(), PAGE_PROCESSING); }
